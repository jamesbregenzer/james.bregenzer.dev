      ...
      list.innerHTML = projects
        ...
        .map(
          ...
          <article class="project-record">
            ...
            <a class="project-link" href="${project.url || project.repo}"${(project.url || project.repo)?.startsWith("http") ? ' target="_blank" rel="noreferrer"' : ""}>Open Project <span aria-hidden="true">→</span></a>
          </article>`,
        )
        .join("");
    })
